## [X] Keep last PORT in memory and use it again if available
## [X] Change the logic and create a GUI agent-installer in GO
## [X] Hide install button once agent is downloaded
